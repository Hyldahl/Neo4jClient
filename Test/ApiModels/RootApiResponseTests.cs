...
namespace Neo4jClient.Test.ApiModels
{
    ...
    public class RootApiResponseTests
    {
        ...
        [TestCase("2.3.0-M02", Result = "2.3.0.2", Description = "Retrieved via REST call from running 2.3.0-M02 install")]
        [TestCase("2.3.1-M02", Result = "2.3.1.2")]
        [TestCase("2.3.0.M02", Result = "2.3.0.2")]
        [TestCase("2.3.1.M02", Result = "2.3.1.2")]
        [TestCase("2.3-1-M02", Result = "2.3")]
        [TestCase("7.2.3.0-M02", Result = "7.2.3.0")]
        [TestCase("     2.3.0-M02", Result = "2.3.0.2")]
        [TestCase("     7.2.3.0-M02", Result = "7.2.3.0")]
